...
class myaccountpage():
    def __init__(self, driver):
        ...
        self.saveaccinfo_button_name = "editAccount"

    def click_myaccount(self):
        self.driver.find_element_by_xpath(
            "//a[@href='/actions/Account.action?editAccountForm=']").click()

    def user_information(self, pwd, rpwd):
        ...
        self.driver.find_element_by_name(self.repeatpassword_textbox_name).clear()
    ...
    def account_information(self, fname, lname, email, phone, address1, address2, city, state, zip, country):
        ...
        self.driver.find_element_by_name(self.lastname_textbox_name).clear()
        ...
        self.driver.find_element_by_name(self.address1_textbox_name).clear()
        self.driver.find_element_by_name(self.address1_textbox_name).send_keys(address1)
        self.driver.find_element_by_name(self.address2_textbox_name).clear()
        ...
        self.driver.find_element_by_name(self.state_textbox_name).clear()
        self.driver.find_element_by_name(self.state_textbox_name).send_keys(state)
        self.driver.find_element_by_name(self.zip_textbox_name).clear()
