...
class JPetStoreTest(unittest.TestCase):
    ...
    def test_case_NewOrderFormPage_to_BuyFish(self):
        driver = self.driver
        neworder = neworderform(driver)
        neworder.PaymentDetails("11121212121211", "12/21")
        neworder.BillingAddress("SSUET", "Engineers","7-C Lane 2", "Karachi", "Sindh", "75500", "Pakistan")
        #neworder.tick_DifferentShippingAddress()
        # neworder.click_continue()
        # neworder.DifferentShippingAddress("ABC", "XYZ","7-C Lane 2", "Karachi", "Sindh", "75500", "Pakistan")
        neworder.click_continue()
