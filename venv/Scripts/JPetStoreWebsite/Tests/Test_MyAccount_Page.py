...
class JPetStoreTest(unittest.TestCase):
    ...
    def test_case_MyAccountPage(self):
        driver = self.driver
        ...
        My_Acc.account_information("SSUET","Engineers", "ssuetengineers@gmail.com","1234567890","Lane 2","Lane 1","Karachi","Sindh","75500","Pakistan")
